...
Load the tissue wide CorShrink and gene wide CorShrink estimated matrices, along with pairwise sample correlation matrix - generated from complete observations for each pair of tissues. 
...
We check the dimensions, both will be $(53, 53, 16069)$ corresponding to $53$ tissues and $16069$ genes. 
