---
title: "CorShrink on *huge* graphs - Cluster network"
author: "Kushal K Dey"
date: "1/1/2018"
...
L = huge.generator(n=10,d=200, graph="cluster") # Generate data with cluster structures
...
out.npn = huge(X.npn, lambda = seq(0.98, 0.01, length.out = 100), method = "glasso", cov.output = TRUE)
...
```{r}
library(huge) # Load the package huge
L = huge.generator(n=50,d=200,graph="cluster") # Generate data with cluster structures
X = L$data; X.pow = X^3/sqrt(15) # Power Transformation
X.npn = huge.npn(X.pow) # Nonparanormal
```
