---
title: "CorShrink on huge graphs - Hub network"
author: "Kushal K Dey"
date: "1/1/2018"
...
L = huge.generator(n=10,d=200,graph="hub", g=5) # Generate data with hub structures
X = L$data;
```
```{r}
...
out.npn = huge(X, lambda = seq(0.98, 0.01, length.out = 100),  method = "glasso", cov.output = TRUE)
...
```{r}
library(huge) # Load the package huge
L = huge.generator(n=50,d=200,graph="hub", g=5) # Generate data with hub structures
X = L$data;
```
