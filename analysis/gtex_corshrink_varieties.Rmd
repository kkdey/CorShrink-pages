...
tissuewide_corshrink_nonmode <- get(load("../output/tissuewide_pearson_halfuniform_tissuewide_non_mode.rda"))
genewide_corshrink_nonmode <- get(load("../output/genewide_ash_out_tissue_mat_halfuniform_non_mode.rda"))
```
