...
library(gridExtra)
num <- 20
eigenvalue_trends <- get(load("../output/eigenvalues_sqrt_distribution/hub_sqrt_eigenvalues_distribution.rda"))
...
eigenvalue_trends <- get(load("../output/eigenvalues_sqrt_distribution/toeplitz_sqrt_eigenvalues_distribution.rda"))
...
eigenvalue_trends <- get(load("../output/eigenvalues_sqrt_distribution/banded_precision_sqrt_eigenvalues_distribution.rda"))
